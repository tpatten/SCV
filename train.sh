...
python3 -u train.py --name scv-awi --stage awi --validation awi --output outputs/awi --num_steps 120000 --lr 0.00025 --image_size 600 2464 --wdecay 0.0001 --gpus 0 --num_k 8 --batch_size 4 --iters 8 --val_freq 10000 --print_freq 100 --checkpoint outputs/sintel/scv-sintel.pth