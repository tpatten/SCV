...
python3 -u train.py --name scv-awi --stage awi --validation awi --output outputs/awi --num_steps 120000 --lr 0.00025 --image_size 600 1232 --wdecay 0.0001 --gpus 0 --num_k 8 --batch_size 2 --iters 8 --val_freq 1000 --print_freq 100 --restore_ckpt /home/tpatten/Code/SCV/checkpoints/quarter/scv-sintel.pth --wandb
